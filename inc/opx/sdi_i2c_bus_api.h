...
/**
 * @brief sdi_i2c_read
 * Execute I2C Read on Slave.
 * Format:
 * <b>
 * start (1) : slave address (7) : wr (1) : ACK (1) : cmd (8) : ACK(1) :
 * cmd (8) :  ACK(1) : stop (1)
 * start (1) : slave address (7) : rd (1) : ACK (1) : DATABYTE (8) : ack(1) :
 * DATABYTE (8) : ack(1) : NOACK(1)
 * stop (1)
 * </b>
 * @param[in] bus_handle : i2c bus handle
 * @param[in] i2c_addr : i2c slave address
 ...
 * @param[out] buffer : read from slave via i2c
...
/**
 * @brief sdi_i2c_write
 * Execute I2C Write on Slave.
 * Format:
 * <b>
 * start (1) : slave address (7) : wr (1) : ACK (1) : cmd (8) : ACK(1) :
 * cmd (8) :  ACK(1) : databyte (8) : ACK(1) : stop (1)
 * </b>
 * @param[in] bus_handle : i2c bus handle
 * @param[in] i2c_addr : i2c slave address
 * @param[in] cmd : list of write offsets
 * @param[in] cmdlen : no. of offsets
 * @param[in] buffer : data to be written to slave via i2c
